...
const Sidebar = ({ isOpen, closeSidebar }) => {
  ...
  return (
    <aside
      onClick={closeSidebar}
      className={`fixed md:static top-0 md:top-0 left-0 w-60 h-[calc(100vh-64px)] md:h-screen
        bg-gray-900 border-r border-gray-800 z-40 shadow-lg
      ...
      >
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-2 py-2 px-4 
                     bg-teal-600 text-white rounded-md font-semibold 
